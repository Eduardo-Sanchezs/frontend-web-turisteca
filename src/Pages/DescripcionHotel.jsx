...
const DescripcionHotel = () => {
    ...
    return (
        <>
            <div className="h-screen bg-[url('/MotelCalifornia.jpg')] bg-cover bg-center">
            ...
            <div className="w-full flex justify-center mt-10 px-4">
                <div className="max-w-screen-lg w-full">
                    <h1 className="text-[#409223] text-4xl md:text-5xl font-bold mt-5">Hotel California</h1>
...
const ListaHoteles = ({ expandido, setExpandido }) => {
    ...
    return (
        <div className="w-full flex flex-col items-center mt-10 px-4">
            <h2 className="text-[#409223] text-2xl md:text-3xl font-bold mb-5 text-center">Destinos Cercanos:</h2>
...
export default DescripcionHotel;
